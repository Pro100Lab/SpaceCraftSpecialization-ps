        ...
        <v-card class="mt-3">
            <v-row>
                ...
                <v-col cols="4" >
                    <div class="px-4 py-4">
                        ...
                        <v-btn class="rounded-0" color="blue" block v-on:click="onCartClicked()"
                        >В корзину</v-btn>
                        <v-spacer/>
                    </div>
                </v-col>
            ...
            <v-row>
                <v-col cols="8">
                    ...
                    <v-card-text v-if="detailed && detailed.length > 0" class="px-8" v-html="detailed.replaceAll('. ', '&lt;br/&gt;')
                                                                        .replaceAll(';', '&lt;br/&gt;')
                                                                        .replaceAll('·', '•')
">
                    </v-card-text>
                </v-col>
                <v-divider v-if="properties && properties.length > 0" vertical/>
                <v-col cols="4">
                    <h3 class="text-center" v-if="this.title !== 'Стандартная установка кондиционера'">Характеристики</h3>
